...
export function avgColor(a: string, b: string): string {
  ...
  return rgbToHex({
    r: Math.round((parseInt(h1.slice(1, 3), 16) + parseInt(h2.slice(1, 3), 16)) / 2),
    g: Math.round((parseInt(h1.slice(3, 5), 16) + parseInt(h2.slice(3, 5), 16)) / 2),
    b: Math.round((parseInt(h1.slice(5, 7), 16) + parseInt(h2.slice(5, 7), 16)) / 2),
  });
}
